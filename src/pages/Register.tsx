    ...
    <div className="max-w-md mx-auto mt-8 px-4 sm:px-0">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Join Smart Mandi to connect directly</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="space-y-2">
              <Label>I am a</Label>
              <Select value={role} onValueChange={(val: 'farmer' | 'buyer') => setRole(val)}>
                <SelectTrigger>
                  <SelectValue placeholder="Select role" />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="farmer">Farmer</SelectItem>
                  <SelectItem value="buyer">Buyer / Wholesaler</SelectItem>
                </SelectContent>
              </Select>
            </div>
